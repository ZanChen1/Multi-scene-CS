...
for denoize_choice =  10 %[4,19,22,23]  % [4,19,22,23]
    for set = 12 %[12,13]
...
%                 [measure_1,~] = para_set_individual(measure, denoize_choice, Test_image_dir_1,Test_image_dir_2, seed_1);
%                 [measure_2,~] = para_set_individual(measure_1, denoize_choice, Test_image_dir_2,Test_image_dir_1, seed_2);
                %%
                Test_image_dir_1 = fullfile(Test_image_dir, measure.Image_name_1);
