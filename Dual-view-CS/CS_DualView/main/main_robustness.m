...
SR = [10,20,30];%[4,10,20,25,30,40,50];
...
for denoize_choice = 26%[3,4,8,19,22] 
    for set = 14 %[12,13]
        ...
        for kk= 1:3
            ...
            for sigma = [5,10,15,20,25,30,35]%1:15
                PSNR_sum = 0;
                SSIM_sum = 0;
                MSE_sum = 0;
                ...
                for k = 1:int32(img_num)
                    ...
                    %%
                    measure_1.noise_im = gaussian_noise(measure_1.ori_im, 0, sigma);
                    measure_2.noise_im = gaussian_noise(measure_2.ori_im, 0, sigma);
%                     imwrite(uint8(measure_1.noise_im),'measure_1.noise_im.tif')
%                     imwrite(uint8(measure_2.noise_im),'measure_2.noise_im.tif')
%                     fprintf('加噪后：Image_name_1:%s, PSNR:%f, SSIM:%f \n',  measure.Image_name_1,  csnr(measure_1.noise_im, measure_1.ori_im, 8,0, 0), cal_ssim(measure_1.noise_im, measure_1.ori_im, 0, 0));
%                     fprintf('加噪后：Image_name_2:%s, PSNR:%f, SSIM:%f \n',  measure.Image_name_2,  csnr(measure_2.noise_im, measure_2.ori_im, 8,0, 0), cal_ssim(measure_2.noise_im, measure_1.ori_im, 0, 0));

                    [rec_im_1,rec_im_2,MSE_im_1,MSE_im_2] = Enc_main(measure_1.noise_im, measure_2.noise_im, measure_1, measure_2);
                    ...
                    fprintf('Denoiser:%s, Rate:%f, measure_model:%s,sigma:%f \n',measure_1.denoize_name, measure_1.rate, measure_1.model, sigma);
                    fprintf('去噪后:Image_name_1:%s, PSNR:%f, SSIM:%f, MSE:%f \n',  measure.Image_name_1,  csnr(rec_im_1, measure_1.ori_im, 8,0, 0), cal_ssim(rec_im_1, measure_1.ori_im, 0, 0),MSE_im_1);
                    fprintf('去噪后:Image_name_2:%s, PSNR:%f, SSIM:%f, MSE:%f \n',  measure.Image_name_2,  csnr(rec_im_2, measure_2.ori_im, 8,0, 0), cal_ssim(rec_im_2, measure_2.ori_im, 0, 0),MSE_im_2);

                    fp = fopen(['../results/', Test_set{set}, '/', measure_1.denoize_name,'_multi_robustness.csv'],'a');
                    fprintf(fp,'%s, %s, %f, %f, %f,%f,%f\n', measure.Image_name_1, measure_1.denoize_name,sigma,measure_1.rate,csnr(rec_im_1, measure_1.ori_im, 8,0, 0), cal_ssim(rec_im_1, measure_1.ori_im, 0, 0),MSE_im_1);
                    fprintf(fp,'%s, %s, %f, %f, %f,%f,%f \n', measure.Image_name_2, measure_2.denoize_name,sigma,measure_2.rate,csnr(rec_im_2, measure_2.ori_im, 8,0, 0), cal_ssim(rec_im_2, measure_2.ori_im, 0, 0),MSE_im_2);
                    fclose(fp);
                ...
                fp = fopen(['../results/', Test_set{set}, '/', measure_1.denoize_name,'_average','_multi_robustness.csv'],'a');   
                fprintf(fp,'%s, %s, %f, %f,%f,%f,%f\n', measure.Image_name_1, measure_1.denoize_name,sigma,measure_2.rate,PSNR_eve, SSIM_eve,MSE_eve);
                fclose(fp);
            end
