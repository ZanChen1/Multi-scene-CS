function [x_hat,PSNR_sum] = Prox_Moment_alpha(y,iters,width,height,denoiser,M_func,Mt_func,measure,PSNR_func)
...
x_hat=reshape(x_t{2},[width height]);
% imshow(x_hat,[]);
