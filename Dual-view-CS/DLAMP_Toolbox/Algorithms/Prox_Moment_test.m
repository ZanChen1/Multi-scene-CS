function [x_hat,PSNR] = Prox_Moment_test(y,iters,width,height,denoiser,M_func,Mt_func,measure,PSNR_func)
...
x_hat = x_t{1};
x_range = -110:1:110;
sigma_x_hat=SigEstmate_SigCNN(reshape(x_hat,height,width));
x_re = measure.ori_im(:)-x_hat;
...
hold off
dlmwrite(['../results/boat_6th_itration',num2str(measure.rate),'.csv'],x_re);
