...
% ---- minimal compatibility for single-view branches (do not change dual-view logic) ----
A  = A_1;
At = At_1;
ori_im = ori_im_1;
errfxn = @(x_hat) PSNR(ori_im, reshape(x_hat, [measure_1.image_height, measure_1.image_width]));
% --------------------------------------------------------------------------------------
