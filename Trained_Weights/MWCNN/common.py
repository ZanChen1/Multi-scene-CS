...
def default_conv(in_channels, out_channels, kernel_size, bias=True, dilation=1, groups=1):  #若k =3  则无论d为多少图像大小不变
    return nn.Conv2d(
        in_channels, out_channels, kernel_size,
        padding=(kernel_size // 2) * dilation , bias=bias, dilation=dilation, groups=groups)  #padding=(kernel_size // 2) + dilation - 1
