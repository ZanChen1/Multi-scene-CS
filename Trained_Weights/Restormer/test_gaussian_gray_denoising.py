...
parser.add_argument('--Datasets', default='[Set11, Set12, BSD68, Urban100_gray]', type=str, help='Directory of validation images')

parser.add_argument('--result_dir', default='./results/Gaussian_Gray_Denoising/', type=str,
                    help='Directory for results')
parser.add_argument('--weights', default='./pretrained_models/gaussian_gray_denoising', type=str,
...
parser.add_argument('--model_type', default='blind', choices=['non_blind', 'blind'], type=str,
                    help='blind: single model to handle various noise levels. non_blind: separate model for each noise level.')
...
# datasets = ['Set11', 'BSD68', 'Urban100_gray']
datasets = ['Set12']
    ...
    for dataset in datasets:
        ...
        with torch.no_grad():
            for file_ in tqdm(files):
                ...
                img_o = np.float32(utils.load_gray_img(file_)) / 255.
